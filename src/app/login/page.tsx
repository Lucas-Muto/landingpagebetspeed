...
export default function Login() {
  ...
  return (
    <>
      {/* Estilos específicos para telas menores ou iguais a 430px */}
      <style jsx global>{`
      ...
      <div id="main-container" className="flex h-screen min-h-screen overflow-hidden items-center justify-center bg-black font-poppins smaller:h-[932px] smaller:overflow-hidden">
        ...
        <div className="smaller:block hidden mr-[35px] mt-[-780px] absolute text-center z-20">
        ...
        <div className="smaller:block hidden mr-[70px] mt-[-350px] absolute text-center z-20">
          {/* Imagem "parabens" substituindo os textos */}
          <Image
            src={novo}
            alt="Parabéns"
        ...
        <div className="smaller:block hidden mr-6 mt-[200px] absolute text-center z-20">
          {/* Imagem "parabens" substituindo os textos */}
          <Image
            src={raio2}
            alt="Parabéns"
